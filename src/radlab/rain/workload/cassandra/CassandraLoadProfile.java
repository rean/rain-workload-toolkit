...
public class CassandraLoadProfile extends StorageLoadProfile 
{
	...
	public CassandraLoadProfile(JSONObject profileObj) throws JSONException 
	{
		super(profileObj);
	...
	public CassandraLoadProfile(long interval, int numberOfUsers, String mixName) 
	{
		super(interval, numberOfUsers, mixName);
	}

	public CassandraLoadProfile(long interval, int numberOfUsers, String mixName, long transitionTime) 
	{
		super(interval, numberOfUsers, mixName, transitionTime);
	}

	public CassandraLoadProfile(long interval, int numberOfUsers, String mixName, long transitionTime, String name) 
	{
