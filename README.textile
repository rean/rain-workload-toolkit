...
# Modify configuration files to describe a run (see "Anatomy of a Configuration File:http://wiki.github.com/yungsters/rain-workload-toolkit/anatomy-of-a-configuration-file for descriptions of configuration parameters and the *'config'* directory in the source tree for examples)
